...
const faqs = [
  ...
  ["What happens in the free chat?", "We will ask what is slowing the business down, map the easiest win, and tell you plainly what we would do next. No jargon and no sales performance."],
];
    ...
    <main className="novix-site" style={themeVars}>
      ...
      <section className="hero shell" id="top">
        <div className="hero-copy">
          ...
          <Reveal delay={220} className="hero-cta-row"><a className="button button-primary" href="#contact">Book a free chat <ArrowUpRight size={16} /></a><a className="text-link" href="#services">See what we build <ArrowDownRight size={16} /></a></Reveal>
        ...
        <Reveal className="hero-media" delay={180}>
          ...
          <div className="hero-sticker">built for<br /><strong>real work</strong></div>
        </Reveal>
      </section>
      ...
      <a className="floating-call" href="#contact" aria-label="Book a free chat"><Clock3 size={17} /><span>Book a free chat</span></a>
