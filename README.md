...
**Not yet wired:** a Cal.com webhook for `/law-offices` and direct bookings (so a booking made without going through the contact form still lands in the CRM) — planned as a follow-up once this contact-form path is confirmed working end-to-end.
